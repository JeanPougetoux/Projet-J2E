...
<body class="blue lighten-4">
		...
		<div class="modal-content">
			...
			<div class="row">
				<form action="/projet-tasks-esgi/tasks/modify" method="post">
					...
					Description : <input type="text" id="descriptionTask" name="description"><br>
					<div class="row" id="priorityTask">
						<label class="col s3"> <input id="radio1" name="priority" value=1
							type="radio" /> <span>Basse</span>
						</label> <label class="col s3"> <input id="radio2" name="priority" value=2
							type="radio" /> <span>Moyenne</span>
						</label> <label class="col s3"> <input id="radio3" name="priority" value=3
							type="radio" /> <span>Haute</span>
						</label> <label class="col s3"> <input id="radio4" name="priority" value=4
							type="radio" /> <span>Urgente</span>
						</label>
					</div>
					<input type="submit" value="Submit">
						...
						<tbody>
							<c:forEach items="${urgentTasks}" var="task">
								<tr>
									...
									<input type="hidden" class="priorityTask" value="${task.priority}" />
									<input type="hidden" class="descriptionTask" value="${task.description}" />
	...
	<div class="fixed-action-btn">
		<a class="btn-floating btn-large blue lighten-1 modal-trigger"
